    ...
    if (selectedCompany != null &&
      ...
      if (response) {
        ...
        safeOperation(() async {
          ...
          await TextDialog.show(context: context, text: 'Your post has been created successfully');
        });
      ...
      safeOperation(() async {
        Navigator.pop(context);
        await TextDialog.show(context: context, text: 'Your post has not been created');
      });
      changeLoading();
      return;
    }

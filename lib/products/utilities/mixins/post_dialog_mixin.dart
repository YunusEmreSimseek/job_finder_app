...
mixin PostDialogMixin<T extends StatefulWidget> on PostMixin<T> {
  ...
  void initState() {
    ...
    Future.microtask(() => _companyServiceManager.getAllCompanies()).then((value) {
      Logger().i('future has done');
      if (value != null) {
        getCubit<CompanyCubit>().setCompanies(value);
      }
